...
{
    /// <summary>
    /// Represents a Grand Theft Auto III save data file for the PlayStaton 2 console platform (Japan).
    /// </summary>
    public class SaveDataFilePS2JP : SaveDataFile
    {
        private const int SizeOfSimpleVars = 0xB0;

        public SaveDataFilePS2JP()
            : base(GamePlatform.PlayStation2JP)
        {
